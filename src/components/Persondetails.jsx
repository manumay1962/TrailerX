...
const Persondetails = () => {
  ...
  return info ? (
    ...
    <div className="px-[10%] w-screen flex flex-col overflow-auto p-5 ">
    {/* Part 1 navigation */}
    <nav className="h-[10vh] my-3 w-full text-zinc-100 flex items-center gap-10 font-xl ">
      <Link
        onClick={() => navigate(-1)}
    ...
    <div className="w-full flex">
      ...
      <div className="w-[20%] ">
        <img
          className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[35vh] object-contain  "
