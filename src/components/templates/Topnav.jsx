...
const Topnav = () => {
  ...
  return (
    <div className="w-full h-[10vh] relative  flex items-center justify-start ml-[12%]">
      ...
      {query.length > 0 && searches.length > 0 && (
        <div className="bg-zinc-200 overflow-auto w-[50%] absolute z-[100] h-[50vh] ml-16 rounded top-[100%]">
          {searches.map((s, i) => (
